...
from app.core.dependencies import require_admin, require_super_admin, get_current_user, require_teacher
...
def today_summary(
    ...
    return summary_service.get_today_summary(db, target)
...
def faculty_workload_report(
    ...
    return credit_service.get_faculty_workload_report(db)
